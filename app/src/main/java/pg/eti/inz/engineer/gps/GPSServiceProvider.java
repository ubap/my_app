...
public class GPSServiceProvider {
    ...
    private static GPSServiceProvider instance;
    ...
    public static GPSServiceProvider getInstance() {
        if (instance == null) {
            instance = new GPSServiceProvider();
        }
        return instance;
    }
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            Log.d();
            GPSServiceProvider.this.service = (CoreService.GPSBinder) service;
